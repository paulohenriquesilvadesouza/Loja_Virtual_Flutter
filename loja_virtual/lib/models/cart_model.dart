...
class CartModel extends Model {
  ...
  void _loadCartItems() async {
    QuerySnapshot quary = await Firestore.instance.collection("users").document(user.firebaseUser.uid).collection("cart")
      .getDocuments();

    products = quary.documents.map((doc) => CartProduct.fromDocument(doc)).toList();
